                    ...
                    <div class="col-span-12">
                        <form action="{{ route('admin.users.store') }}" method="post">
                            ...
                            <div class="mb-4">
                                ...
                                <input id="date_in" name="date_in" type="date" class="w-full rounded border-gray-100 placeholder:text-sm focus:border focus:border-violet-500 focus:ring-0 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100 dark:text-zinc-100">
                                @error('date_in')
                                <p class="text-red-600 mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input id="date_out" name="date_out" type="date" class="w-full rounded border-gray-100 placeholder:text-sm focus:border focus:border-violet-500 focus:ring-0 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100 dark:text-zinc-100">
                                @error('date_out')
                                <p class="text-red-600 mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input id="cost" name="cost" type="number" class="w-full rounded border-gray-100 placeholder:text-sm focus:border focus:border-violet-500 focus:ring-0 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100 dark:text-zinc-100">
                                @error('cost')
                                <p class="text-red-600 mt-2">{{ $message }}</p>
                                @enderror
                            </div>
