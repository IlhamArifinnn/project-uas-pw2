        ...
        <div data-simplebar class="h-full">
            ...
            <div id="sidebar-menu">
                ...
                <ul class="metismenu" id="side-menu">
                    ...
                    <li>
                        <a href="{{ route('admin.vehicle-types.index') }}" class="pl-6 pr-4 py-3 block text-sm font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">
                            <i data-feather="file"></i>
                            <span data-key="t-dashboard"> Vehicle Types</span>
                        </a>
                    </li>

                    <li>
                        <a href="{{ route('admin.vehicles.index') }}" class="pl-6 pr-4 py-3 block text-sm font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">
                            <i data-feather="file"></i>
                            <span data-key="t-dashboard"> Vehicles</span>
                        </a>
                    </li>

                    <li>
                        <a href="{{ route('admin.areas.index') }}" class="pl-6 pr-4 py-3 block text-sm font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">
                            <i data-feather="file"></i>
                            <span data-key="t-dashboard"> Area</span>
                        </a>
                    </li>

                    <li>
                        <a href="{{ route('admin.parkings.index') }}" class="pl-6 pr-4 py-3 block text-sm font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">
                            <i data-feather="file"></i>
                            <span data-key="t-dashboard"> Parkings</span>
                        </a>
                    </li>
                </ul>
            </div>
