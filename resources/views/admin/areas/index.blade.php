...
<div class="grid grid-cols-12">
    <div class="col-span-12">
        <h4 class="mb-5 mb-sm-0 text-lg font-semibold grow text-gray-800 dark:text-gray-100">areas</h4>

        <div class="my-5">
            <a href="{{ route('admin.areas.create') }}" class="btn py-2 px-5 text-15 text-green-500 bg-green-50 border-green-50 hover:text-white hover:bg-green-600 hover:border-green-600 focus:text-white focus:bg-green-600 focus:border-green-600 focus:ring focus:ring-green-500/30 active:text-white active:bg-green-600 active:border-green-600 dark:border-transparent">
                create
            </a>
        </div>
