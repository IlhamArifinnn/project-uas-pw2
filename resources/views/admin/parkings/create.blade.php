...
<div class="grid grid-cols-12 gap-5">
    <div class="col-span-12">
        <h4 class="mb-5 mb-sm-0 text-lg font-semibold grow text-gray-800 dark:text-gray-100">Create Parkings</h4>
                    ...
                    <div class="col-span-12">
                        <form action="{{ route('admin.parkings.store') }}" method="post">
                            ...
                            <div class="mb-4">
                                ...
                                <input id="capacity" name="capacity" type="number" class="w-full rounded border-gray-100 placeholder:text-sm focus:border focus:border-violet-500 focus:ring-0 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100 dark:text-zinc-100">
                                @error('capacity')
                                <p class="text-red-600 mt-2">{{ $message }}</p>
                                @enderror
                            </div>
